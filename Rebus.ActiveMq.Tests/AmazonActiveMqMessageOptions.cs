...
namespace Rebus.ActiveMq.Tests
{
    ...
    public class AmazonActiveMqMessageOptions : ActiveMqFixtureBase
    {
        private ActiveMqTransportFactory _transportFactory;

        protected override void SetUp()
        {
            base.SetUp();
            _transportFactory = new ActiveMqTransportFactory();
        }
